...
const translations = {
    pt: {
        ...
        qsStart: "▶️ COMEÇAR",
        qsTiltHint: "📱 Em pé arma o sensor · CIMA = acertou · BEM pra BAIXO = passar",
        qsTiltLock: "📵 Sensor pausado — deixe o celular em pé para armar",
        qsTiltReady: "🎯 Valendo! Cima = acertou · bem pra baixo = passar",
        qsTiltExplain: "📱 Acertou? Vire a tela para <strong style='color:var(--success)'>CIMA (teto)</strong>.<br>Quer pular? Vire <strong style='color:var(--warning)'>BEM para BAIXO (chão)</strong>.<br>O sensor só arma com o celular em pé — ou use os botões.",
        qsGotIt: "✓ ACERTOU",
        qsSkip: "↷ PASSAR",
        qsTimeUp: "⏰ TEMPO!",
    ...
    en: {
        ...
        qsStart: "▶️ START",
        qsTiltHint: "📱 Hold upright to arm · UP = got it · WELL DOWN = skip",
        qsTiltLock: "📵 Sensor paused — hold the phone upright to arm",
        qsTiltReady: "🎯 Live! Up = got it · well down = skip",
        qsTiltExplain: "📱 Got it? Tilt the screen <strong style='color:var(--success)'>UP (ceiling)</strong>.<br>Want to skip? Tilt it <strong style='color:var(--warning)'>WELL DOWN (floor)</strong>.<br>The sensor only arms while the phone is upright — or use the buttons.",
        qsGotIt: "✓ GOT IT",
        qsSkip: "↷ SKIP",
        qsTimeUp: "⏰ TIME!",
    ...
    es: {
        ...
        qsStart: "▶️ COMENZAR",
        qsTiltHint: "📱 En vertical arma el sensor · ARRIBA = acertaste · BIEN ABAJO = pasar",
        qsTiltLock: "📵 Sensor en pausa — mantén el celular en vertical para armar",
        qsTiltReady: "🎯 ¡Listo! Arriba = acertaste · bien abajo = pasar",
        qsTiltExplain: "📱 ¿Acertaste? Inclina la pantalla hacia <strong style='color:var(--success)'>ARRIBA (techo)</strong>.<br>¿Quieres pasar? Inclínala <strong style='color:var(--warning)'>BIEN hacia ABAJO (suelo)</strong>.<br>El sensor solo se arma con el celular en vertical — o usa los botones.",
        qsGotIt: "✓ ACERTÉ",
        qsSkip: "↷ PASAR",
        qsTimeUp: "⏰ ¡TIEMPO!",
